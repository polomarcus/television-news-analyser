...
class ParserTest extends AnyFunSuite {
  ...
  test("parseFrance2Home") {
    ...
    val news = News("Brésil : effondrement meurtrier d'une falaise sur un groupe de touristes",
      description, new Date("01/09/2022"), 1, "Laurent Delahousse", List("C.Verove", "O.Sauvayre"),
  ...
  test("parseDescriptionAuthors") {
    val (description, authors) = Parser.parseDescriptionAuthors("/one-subject-tv-news-fr2.html", localhost)
