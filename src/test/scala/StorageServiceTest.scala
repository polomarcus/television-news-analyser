import com.github.polomarcus.html.{ParserFR2, ParserTF1}
...
class StorageServiceTest extends AnyFunSuite {
  ...
  val newsFr2 = News("Brésil : effondrement meurtrier d'une falaise sur un groupe de touristes changement climatique", description, new Timestamp(new Date("01/09/2022").getTime), 1,
